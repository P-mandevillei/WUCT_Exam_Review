...
1. **Cronbach's $\alpha$**
    ...
    A higher Cronbach's $\alpha$ indicates that the exam is more reliable in testing the same construct. A Cronbach's $\alpha$ higher than $0.9$ is considered excellent and colored green, $0.7 - 0.9$ is considered acceptable and colored orange, and $<0.7$ is considered poor and colored red.<br>
